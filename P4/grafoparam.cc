...
void GrafoParam::draw( const ModoVis p_modo_vis, const bool p_usar_diferido,int contadorMaterial )
{
   ...
   constexpr float
    ...
    glPushMatrix();
        ...
        glColor3f(0,0,1);
        cilindro->draw(modo_vis,usar_diferido,material);
    glPopMatrix();
    // base
    glPushMatrix();
        ...
        glPushMatrix();
            ...
            glPushMatrix(); 
                ...
                glPushMatrix();
                     glTranslatef(6,0,0);
                     glColor3f(1,0.5,0);
                     esfera->draw(modo_vis,usar_diferido,material);
                    glPushMatrix();
...
void GrafoParam::caraCubos()
{
   ...
   //  cubos a la mitad
        glColor3f(1,0,0);
        glPushMatrix(); 
            cubo->draw(modo_vis,usar_diferido,material);
        glPopMatrix();  
